...
def load_loss_history(fname):
    ...
    val_loss_history = df['validation_loss'].values if 'validation_loss' in df.columns else None
    lr_history = df['learning_rate'].values if 'learning_rate' in df.columns else None
    loss_noreg_history = df['loss_noreg'].values if 'loss_noreg' in df.columns else None
    val_loss_noreg_history = df['validation_loss_noreg'].values if 'validation_loss_noreg' in df.columns else None
